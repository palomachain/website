  ...
  <section className="what-is-paloma-section">
    ...
    <div className="describe-card describe-card-white">
      ...
      <div>
        ...
        <span className="mt-20">
          Paloma aims to make blockchain messaging ubiquitous and extremely easy for developers.
          Paloma messages are bi-directional and may be repeated or scheduled. Developers can write
          smart contracts in any language accepted by their target blockchain.
          <br />
          <br />
          Developers can control state change logic execution with Paloma's Cosmwasm language.
          Paloma's gas price oracle is unique. Paloma aims to be a decentralized and global gas
          price oracle. Pigeons observe gas prices and provide quotes for message delivery. These
          quotes include a query or message relay fee for the Pigeon Relayers who will execute the
          message.
          <br />
          <br />
          Pigeons will price in the gas price risks, so developers will have dependable message
          delivery costs analysis for any target chain and any message size.
        </span>
        <div className="btns">
