...
const howToWorkSection = () => (
  <section className="howtowork-section">
    <img
      src="/assets/home/pigeons-fly.png"
      alt="pigeons-fly"
    ...
    <p className="p-describe p-white">
      The Paloma Protocol is the FedEx for Blockchains. When you need to get a
      message to any blockchain smart contract, with speed, trust the Paloma
      pigeons to deliver the message.
    </p>
