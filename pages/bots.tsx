...
export default function Bots({ state, router }) {
      ...
      <div className="home-page-container">
        ...
        <div className="home-page-section reverse">
          <div className="home-page-text">
            ...
            <p>
              Paloma's bots are low-latency and bidirectional smart contracts that are managed by
              the Paloma blockchain. Paloma validators act as custodians to monitor and execute
              state change instructions sent by developers and by users on target blockchains
              including Ethereum, BSC Chain, Polygon, Ethereum L2s, and any Cosmos-SDK Chain
            </p>
          </div>
        ...
        <div className="home-page-section">
          <div className="home-page-text">
            ...
            <p style={{ textAlign: "left" }}>
              We deliver a game-changer blockchain for developers. our protocol was built from
              developers to developers. Easy to use, easy to love. Get started now!
            </p>
            <a
          ...
          <div className="home-how-to-build">
            <div className="home-how-item ">
              ...
              <div className="content">
                <h1>Create a Bot</h1>
                <p>
                  Create your bot with a simple command-line entry on Paloma. Pay for your bot's gas
                  in GRAINs or ETH at the command line. Let fly!
                </p>
              </div>
            </div>
            ...
            <div className="home-how-item second">
              ...
              <div className="content">
                ...
                <p>
                  Use Paloma's Python or JavaScript SDK to send a transaction or command to your bot
                  on Paloma and your desired target chain. Watch your bot interact with other
                  contracts.
                </p>
              </div>
            </div>
            ...
            <div className="home-how-item third">
              ...
              <div className="content">
                ...
                <p>
                  Use Paloma to determine when to fire the next bot message to the pigeons. Pay gas
                  in GRAINs or ETH.
                </p>
              </div>
              <a
