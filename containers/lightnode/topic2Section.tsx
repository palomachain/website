  ...
  <section className="topic-section">
    ...
    <div className="topic">
      <p>
        ...
        impressed with the team's continuous improvements since Paloma’s mainnet and look forward to their Curvebots
        growing more Curve volume and product offerings for the Curve community!”
      </p>
