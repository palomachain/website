...
const TokenSelectModal = ({
  ...
  return (
    <Modal title="Select token" onBack={onBack} className={style.container}>
      <SearchInput
        value={search}
      ...
      {tokenLoading && (
        <section>
          <img className={style.loadingImage} src="/assets/images/Pigeon_loading.svg" width={94} height={100} />
