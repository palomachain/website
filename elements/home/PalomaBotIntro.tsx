    ...
    <div className="paloma-bot-intro-container">
      <div className="home-page-text">
        ...
        <p className="description">
          Create secure, fast, private, and decentralized blockchain trading bots for any public blockchain. Keep all
          your strategies and bot revenues for yourself and your community.
        </p>
        <a href={PALOMABOT_WEBSITE_LINK} className="home-page-button" target="_blank">
          Create a Bot
